...
void log_snapshot(const runtime_snapshot &snapshot)
{
    ...
    std::snprintf(
        line,
        sizeof(line),
        "[DSRRL VIRTUAL ENVSPEC V3] P=%llu PACK=%u native_desc=%llu "
...
extern "C" __declspec(dllexport) const char *NAME =
    "DSRRL PTDE Virtual EnvSpec V3";
extern "C" __declspec(dllexport) const char *DESCRIPTION =
    "Broad exact-native-probe PTDE-to-DSR-topology virtual EnvSpec diagnostic.";
    ...
    HMODULE reshade_module)
{
    ...
    if (!load_pack(addon_module)) {
        reshade::log::message(
            ...
            "[DSRRL VIRTUAL ENVSPEC V3] canonical PackedGI load/SHA failed; fail-open");
    }
    else {
        reshade::log::message(
            reshade::log::level::info,
            "[DSRRL VIRTUAL ENVSPEC V3] canonical PackedGI PASS; native DSR probe fingerprint bridge armed");
    }
