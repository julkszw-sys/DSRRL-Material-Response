...
constexpr std::array<operator_contract, operator_count> k_catalog = {{
    ...
    {operator_id::subsurface, "bridge.subsurface", "renderer.core.islands.subsurface_plain_route_contract_v1", "PTDE Subsurface route island", canonical_status::high_confidence, port_state::off, carrier_kind::hybrid, require_receiver | require_material | require_resource | require_consumer, true},
    ...
    {operator_id::faceeye_shadow_legacy, "surface.faceeye_shadow_legacy", "renderer.ptde.faceeye_shadow_operator_v1", "PTDE FaceEye legacy shadow/environment operator", canonical_status::confirmed, port_state::blocked, carrier_kind::hybrid, require_receiver | require_resource | require_consumer, true},
