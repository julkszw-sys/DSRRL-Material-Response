    ...
    const draw_tx_mutation &mutation) noexcept
{
    ...
    // Skip only the high-frequency U/L PS+b13 transaction shape. Mixed
    // MR/Lerp/SpecRGB/resource batches that merely contain the U/L owner keep
    // full native bind/restore verification.
