...
enum class local_specular_runtime_reason : std::uint8_t {
    ...
    material_terms_not_verified,
    spec_rgb_route_not_ready,
    source_amplitude_not_ready,
...
struct local_specular_runtime_context {
    ...
    bool material_c101_c102_verified=false;
    ...
    bool clustered_membership_sidecar_ready=false;
...
struct local_specular_runtime_plan {
    bool ready=false;
    local_specular_runtime_reason reason=
