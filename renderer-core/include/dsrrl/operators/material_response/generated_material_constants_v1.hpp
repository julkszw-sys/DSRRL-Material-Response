...
inline constexpr std::array<material_response_constants,34> k_material_response_constants_v1 = {{
    ...
    {3u,{{0.5f,0.5f,0.5f}},{{1.0f,1.0f,1.0f}},0.0f,false},
    ...
    {16u,{{0.5f,0.5f,0.5f}},{{1.37035098f,1.37035098f,1.37035098f}},60.0f,true},
    {17u,{{0.5f,0.5f,0.5f}},{{1.37035098f,1.37035098f,1.37035098f}},60.0f,true},
    ...
    {60u,{{0.5f,0.5f,0.5f}},{{1.0f,1.0f,1.0f}},0.0f,false},
    {88u,{{0.5f,0.5f,0.5f}},{{1.0f,1.0f,1.0f}},2.0f,true},
    {160u,{{0.5f,0.5f,0.5f}},{{1.0f,1.0f,1.0f}},2.0f,true},
    {167u,{{0.5f,0.5f,0.5f}},{{1.37035098f,1.37035098f,1.37035098f}},60.0f,true},
    {190u,{{1.5f,1.5f,1.5f}},{{1.37035098f,1.37035098f,1.37035098f}},0.0f,false},
    {197u,{{0.5f,0.5f,0.5f}},{{1.37035098f,1.37035098f,1.37035098f}},60.0f,true},
    {229u,{{0.5f,0.5f,0.5f}},{{1.51663761f,1.51663761f,1.51663761f}},8.5f,true},
    {231u,{{0.5f,0.5f,0.5f}},{{1.37035098f,1.37035098f,1.37035098f}},60.0f,true},
    {232u,{{0.5f,0.5f,0.5f}},{{1.0f,1.0f,1.0f}},0.0f,false},
    {276u,{{0.5f,0.5f,0.5f}},{{1.0f,1.0f,1.0f}},2.0f,true},
    {312u,{{0.5f,0.5f,0.5f}},{{1.0f,1.0f,1.0f}},0.0f,false},
