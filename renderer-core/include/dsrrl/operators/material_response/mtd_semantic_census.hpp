...
enum class mtd_semantic_source : std::uint8_t { none=0,full24_exact_cohort,exact_override,exact_binding_extension,envspec_router_exact,ptde_flver_texture_semantics_exact,flver_pairwise_stable_exact,mtd_spx_pairwise_negative_exact };
