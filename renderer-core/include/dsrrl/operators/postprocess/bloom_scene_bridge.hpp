...
// Route and blend proofs must refer to the same concrete FX material instance.
// Independently closing each axis with evidence from different materials is not
// a valid recurrence proof (e.g. WaterWaveSfx mode9 cannot label an unrelated collector draw).
