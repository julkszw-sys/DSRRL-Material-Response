...
struct spec_rgb_bind_request{operators::resource_bridges::spec_rgb_context route{};std::u16string logical_name;spec_rgb_resource_handle currently_bound_t1=0;};
struct spec_rgb_bind_plan{operators::resource_bridges::spec_rgb_decision route{};bool activate=false;spec_rgb_resource_handle preserved_t1_srv=0;spec_rgb_resource_handle ptde_t10_srv=0;};
