...
def main() -> int:
    ...
    if [r['plan_index'] for r in rows] != list(range(36)):
        raise SystemExit('plan_index must be contiguous 0..35')
    ...
    out = [
        ...
        'enum class upper_lower_hemenv_stratum : std::uint8_t { nospc = 0, spc };\n\n',
        'struct upper_lower_hemenv_plan {\n',
        ...
        '};\n\n',
        'inline constexpr std::array<upper_lower_hemenv_plan,36> k_upper_lower_hemenv_plans = {{\n',
    ]
    ...
    for r in rows:
        stratum = (
            ...
            if r['stratum'] == 'spc'
            else 'upper_lower_hemenv_stratum::nospc'
        )
        out.append(
            '    {' +
