...
### Integrated basis used by the exact release materializer

- SHA-256: `db2e6547b5fb5516d4ad6559173e66421315d1635ca0c08e8141b0de2f57f966`
...
### Integrated dedicated DXBC payloads retained
...
No active PackedGI/EnvSpec resource replacement or EnvSpec loader is part of the final shipping path. Activation telemetry, periodic status telemetry and startup shader-count telemetry are disabled/removed; safety/error/fail-open logging remains.

The old `41690...` identity documented on the former `main` branch is historical and is **not** the current Nexus shipping addon.
